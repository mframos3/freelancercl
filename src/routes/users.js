...
router.get('users.show', '/:id', loadUser, async (ctx) => {
  ...
  const linkedin = `https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=77c56cbij2arr0&redirect_uri=${redirect}&scope=r_liteprofile%20r_emailaddress%20w_member_social`;
